  ...
  public partial class WebcamDevice : UserControl
  {
    ...
    public static readonly DependencyProperty VideoSourceIdProperty = DependencyProperty.Register("VideoSourceId",
                                                                                                  ...
                                                                                                  new PropertyMetadata(
                                                                                                    string.Empty,
                                                                                                    VideoSourceIdPropertyChangedCallback,
    ...
    public static readonly DependencyProperty SnapshotBitmapProperty = DependencyProperty.Register("SnapshotBitmap",
                                                                                                   ...
                                                                                                   typeof(WebcamDevice),
                                                                                                   new PropertyMetadata(
                                                                                                     SnapshotBitmapPropertyChangedCallback));

    /// <summary>
    /// Dependency property for take snapshot command.
    /// </summary>
    public static readonly DependencyProperty TakeSnapshotProperty = DependencyProperty.RegisterAttached(
      "TakeSnapshot",
      typeof(ICommand),
      typeof(WebcamDevice),
    ...
    private static readonly Lazy<IEnumerable<MediaInformation>> DevicesLazy
      = new Lazy<IEnumerable<MediaInformation>>(GetDevices);

    /// <summary>
    /// Gets video device source collection current available.
    /// </summary>
    public static IEnumerable<MediaInformation> VideoDevices
      => DevicesLazy.Value;

    private static IEnumerable<MediaInformation> GetDevices()
    {
      return new FilterInfoCollection(FilterCategory.VideoInputDevice)
        .Cast<FilterInfo>()
        .Select(info => new MediaInformation
                        {
                          DisplayName = info.Name,
                          UsbId = info.MonikerString
                        })
        .ToList();
    }
    ...
    private static object VideoSourceIdPropertyCoherceValueChanged(DependencyObject dependencyObject, object basevalue)
    {
      ...
      var availableMediaList = VideoDevices;
